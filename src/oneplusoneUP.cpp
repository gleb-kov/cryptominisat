...
OnePlusOneUPSAT::OnePlusOneUPSAT(Solver* _solver) :
    solver(_solver)
{
}

OnePlusOneUPSAT::~OnePlusOneUPSAT()
{
    free(storebase);
    free(clause);
    free(clsize);
...
void OnePlusOneUPSAT::large_mutation()
{
...
void OnePlusOneUPSAT::small_mutation()
{
...
uint32_t OnePlusOneUPSAT::countVarsToFlip()
{
...
void OnePlusOneUPSAT::pickflips(uint32_t flipsCnt)
{
...
size_t OnePlusOneUPSAT::try_unit_propagation()
{
...
template<class T>
OnePlusOneUPSAT::add_cl_ret OnePlusOneUPSAT::add_this_clause(const T& cl, uint32_t& i, uint32_t& storeused) {
    uint32_t sz = 0;
    bool sat = false;
...
bool OnePlusOneUPSAT::init_problem()
{
